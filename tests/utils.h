...
bool matches_mpi3snp_output(const std::vector<Result<int, float>> &v)
{
    std::vector<std::vector<int>> mpi3snp_output{
        {4, 8, 9}, {6, 8, 9}, {3, 8, 9}, {7, 8, 9}, {5, 8, 9}, {0, 8, 9},
        {1, 8, 9}, {2, 8, 9}, {5, 6, 7}, {0, 5, 7}, {0, 4, 5}, {1, 6, 7},
        {1, 2, 7}, {3, 5, 8}, {4, 6, 7}, {6, 7, 8}, {1, 4, 5}, {0, 1, 9},
        {0, 4, 9}, {3, 5, 7}, {4, 7, 9}, {0, 2, 7}, {4, 5, 9}, {0, 1, 2},
        {2, 3, 5}, {1, 7, 9}, {1, 5, 7}, {2, 6, 8}, {1, 7, 8}, {0, 4, 8},
        {0, 3, 5}, {1, 4, 9}, {3, 7, 9}, {0, 1, 7}, {0, 3, 7}, {2, 6, 7},
        {0, 2, 4}, {4, 5, 7}, {5, 7, 8}, {0, 1, 5}, {4, 5, 8}, {0, 1, 3},
        {2, 7, 8}, {2, 4, 6}, {2, 5, 7}, {0, 1, 4}, {3, 6, 7}, {0, 2, 3},
        {5, 6, 8}, {4, 5, 6}, {3, 7, 8}, {0, 4, 7}, {6, 7, 9}, {3, 4, 5},
        {2, 3, 6}, {1, 5, 8}, {2, 3, 7}, {0, 6, 7}, {0, 5, 8}, {0, 1, 6},
        {0, 6, 8}, {0, 2, 5}, {2, 3, 8}, {5, 7, 9}, {2, 4, 7}, {0, 2, 8},
        {1, 3, 7}, {2, 5, 8}, {3, 4, 6}, {0, 3, 8}, {0, 3, 6}, {2, 4, 9},
        {1, 3, 9}, {3, 4, 9}, {0, 3, 9}, {1, 2, 9}, {2, 7, 9}, {1, 2, 8},
        {1, 4, 7}, {1, 3, 8}, {4, 6, 9}, {1, 5, 9}, {1, 3, 5}, {0, 3, 4},
        {0, 4, 6}, {3, 6, 8}, {2, 5, 6}, {0, 2, 6}, {0, 7, 9}, {0, 1, 8},
        {0, 5, 6}, {2, 4, 5}, {1, 2, 5}, {3, 5, 6}, {1, 5, 6}, {0, 7, 8},
        {4, 6, 8}, {2, 6, 9}, {1, 6, 8}, {0, 2, 9}};

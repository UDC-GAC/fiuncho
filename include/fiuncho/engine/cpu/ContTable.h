 ...
 *
 * @brief ContTables structure definition for the auxiliar 2-SNP contingency
 * tables
 */

#ifndef FIUNCHO_CONTTABLE_H
#define FIUNCHO_CONTTABLE_H
